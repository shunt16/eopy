"""
Data factory for opening Sentinel-2/MSI L1 products
"""
...
class MSIL1Factory(MSISharedFactory):
    """
    MSIL1Factory is a sub-class of SnappySharedFactory for opening MSI L1c products
